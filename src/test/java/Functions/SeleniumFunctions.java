...
/*
    public void login(String username, String password) throws Exception {
        By usernameInput = getCompleteElement("usernameInput");
        driver.findElement(usernameInput).sendKeys(username);
        By passwordInput = getCompleteElement("passwordInput");
        driver.findElement(passwordInput).sendKeys(password);
        By submitButton = getCompleteElement("submitButton");
        driver.findElement(submitButton).click();
    ...
    public void viewFlasMessage(String message) throws Exception {
        By byFlashMessage = getCompleteElement("flashMessage");
        WebElement flashMessage =  driver.findElement(byFlashMessage);
        ...
        if (flashMessage.isDisplayed()) {
            ...
            log.error("No se encontró el elemento");
            org.junit.Assert.fail("No se encontró el elemento");
        }
